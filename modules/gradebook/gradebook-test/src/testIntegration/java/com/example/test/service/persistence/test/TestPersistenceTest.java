...
package com.example.test.service.persistence.test;
...
public class TestPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "com.example.test.service"));
	...
	public void testUpdateExisting() throws Exception {
		...
		newTest.setName(RandomTestUtil.randomString());

		newTest.setDescription(RandomTestUtil.randomString());

		newTest.setTestDate(RandomTestUtil.nextDate());
		...
		Assert.assertEquals(existingTest.getName(), newTest.getName());
		Assert.assertEquals(
			existingTest.getDescription(), newTest.getDescription());
		Assert.assertEquals(
			Time.getShortTimestamp(existingTest.getTestDate()),
			Time.getShortTimestamp(newTest.getTestDate()));
		Assert.assertEquals(existingTest.getStatus(), newTest.getStatus());
		Assert.assertEquals(
		...
		Assert.assertEquals(existingTest.getPriority(), newTest.getPriority());
		Assert.assertEquals(
	...
	protected OrderByComparator<Test> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"Test_Test", "testId", true, "name", true, "description", true,
			"testDate", true, "status", true, "companyId", true, "groupId",
			true, "userId", true, "userName", true, "createDate", true,
			"modifiedDate", true, "priority", true, "dueDate", true);
	}
	...
	protected Test addTest() throws Exception {
		...
		test.setName(RandomTestUtil.randomString());

		test.setDescription(RandomTestUtil.randomString());

		test.setTestDate(RandomTestUtil.nextDate());
