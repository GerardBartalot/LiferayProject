...
public interface TestLocalService
	...
	List<Test> getTestsByKeywords(long groupId, String keywords, int start, int end, OrderByComparator<Test> orderByComparator);

	long getTestsCountByKeywords(long groupId, String keywords);

	Test updateTest(long testId, String title, String description, Date dueDate, ServiceContext serviceContext);

	Test addTest(long groupId, String title, String description, Date dueDate, ServiceContext serviceContext);
}