 ...
 * <code>com.example.test.service.impl.TestLocalServiceImpl</code> and
...
public class TestLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.example.test.service.impl.TestLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new test
	 */
	public static Test createTest(long testId) {
	 ...
	 */
	public static Test deleteTest(long testId) throws PortalException {
	...
	public static Test fetchTest(long testId) {
	 ...
	 * @throws PortalException if a test with the primary key could not be found
	 */
	public static Test getTest(long testId) throws PortalException {
	...
	private static final Snapshot<TestLocalService> _serviceSnapshot =
		new Snapshot<>(TestLocalServiceUtil.class, TestLocalService.class);
