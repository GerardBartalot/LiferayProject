package com.example.test.util.validator;
...
@Component(
        immediate = true,
        service = TestValidator.class
)
public class AssignmentValidatorImpl implements TestValidator {
    /**
    ...
    public void validate(
        ...
        if (!isAssignmentValid(title, description, dueDate, errors)) {
            throw new TestValidationException(String.valueOf(errors));
        }
    }
    /**
